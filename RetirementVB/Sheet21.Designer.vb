...
Partial Public NotInheritable Class Sheet2
    ...
    Friend WithEvents AssetCorr As Microsoft.Office.Tools.Excel.NamedRange
    
    Friend WithEvents AssetReturns As Microsoft.Office.Tools.Excel.NamedRange
    ...
    Private Sub BeginInitialization()
        Me.BeginInit
        Me.AssetCorr.BeginInit
        Me.AssetReturns.BeginInit
    End Sub
    ...
    Private Sub EndInitialization()
        Me.AssetReturns.EndInit
        Me.AssetCorr.EndInit
        Me.EndInit
    End Sub
    ...
    Private Sub InitializeControls()
        Me.AssetCorr = Globals.Factory.CreateNamedRange(Nothing, Nothing, "AssetCorr", "AssetCorr", Me)
        Me.AssetReturns = Globals.Factory.CreateNamedRange(Nothing, Nothing, "AssetReturns", "AssetReturns", Me)
    End Sub
    ...
    Protected Overrides Sub OnShutdown()
        Me.AssetReturns.Dispose
        Me.AssetCorr.Dispose
        MyBase.OnShutdown
    End Sub
End Class
