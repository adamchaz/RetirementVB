...
Module MatrixMath
    ...
    ''Public Function ConverToVariant(iMat(,) As Double) As Object
    ''    Dim lVarOUt As Object
    ''    Dim i, j As Long
    ''    ReDim lVarOUt(0 To UBound(iMat, 1), 0 To UBound(iMat, 2))
    ...
    ''End Function
    ''Public Function ConvertToArry(iVar As Object) As Double(,)
    ''    Dim i, j As Long
    ''    Dim lMatOut(,) As Double
    ''    ReDim lMatOut(0 To UBound(iVar, 1), 0 To UBound(iVar, 2))
    ...
    ''    ReDim lIdenity(0 To iOrder, 0 To iOrder)
    ''    Dim i, j As Long

    ''    For i = 1 To UBound(lIdenity)
    ''        lIdenity(i, i) = 1
    ''    Next i
    ...
    Public Function MatrixMultiply(iMat1(,) As Double, iMat2(,) As Double) As Double(,)
        ...
        ReDim lOutMatrix(0 To lNumRows, 0 To lNumColumns)

        For i = 1 To lNumRows
            For j = 1 To lNumColumns
                For k = 1 To UBound(iMat2, 1)
    ...
    ''    ReDim lOutMat(0 To lNumRows, 0 To lNumRows)
    ...
    Public Function MatrixCholesky(iMat(,) As Double) As Double(,)
        ...
        lOutMat(1, 1) = Sqrt(iMat(1, 1))
        lOutMat(2, 1) = iMat(2, 1) / lOutMat(1, 1)
        lOutMat(2, 2) = Sqrt(iMat(2, 2) - lOutMat(2, 1) * lOutMat(2, 1))
        For i = 3 To lNumRows
            lSum2 = 0
            For k = 1 To i - 1
                lsum = 0
            ...
            Next k
            lOutMat(i, i) = Sqrt(iMat(i, i) - lSum2)
        Next i
